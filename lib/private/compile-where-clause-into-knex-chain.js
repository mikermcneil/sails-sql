  ...
  if (_.keys(whereClause).length > 0) {
    ...
    (function $recurse(scruple, kChain, recursionDepth, disjunctMode){
      ...
      if (scrupleKey !== 'and' && scrupleKey !== 'or') {
        ...
        // > The _.bind() calls below are here because of https://github.com/mikermcneil/sails-sql/commit/536bcb18e485b00ba4f7bfe2ec702bfd3b331b2d#commitcomment-31424796
        // > Also note: knex takes care of "is null"/"is not null" automatically
