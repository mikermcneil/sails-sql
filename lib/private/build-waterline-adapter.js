...
module.exports = function buildWaterlineAdapter(driverImpl) {
  ...
  var adapter = {
    ...
    defaults: {
      ...
      // TODO: come up with a better way to do this that doesn't cause conflicts with the configured datastore URL in situations where real stuff is ACTUALLY configured.  It might be fine already I dunno
