...
module.exports = function buildWaterlineAdapter(driverImpl) {
  ...
  var adapter = {
    ...
    registerDatastore: (dsConfig, physicalModelsReport, done)=>{
      console.log('wtf here is what dsConfig is initially:', _.cloneDeep(dsConfig));
      (async()=>{
        ...
        console.log('dsConfig, BEFORE normalization:', dsConfig);
        WLUtils.normalizeDatastoreConfig(dsConfig);
        console.log('dsConfig, AFTER normalization:', dsConfig);
