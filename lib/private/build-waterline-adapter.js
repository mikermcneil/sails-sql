  ...
  var adapter = {
    ...
    registerDatastore: (datastoreConfig, physicalModelsReport, done, meta)=>{
      (async()=>{
        ...
        var manager = await ƒ.createManager(datastoreConfig.url, meta.onUnexpectedFailure || ((unexpectedFailureErr)=>{
          console.warn(
    ...
    teardown: (datastoreName, done, meta)=>{
      (async()=>{
        ...
        // Destroy the manager.
        await ƒ.destroyManager(dsEntry.manager, meta);
    ...
    //    · add module state
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    create: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    createEach: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    update: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    destroy: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    find: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    join: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    count: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    sum: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
    avg: (datastoreName, query, done, meta)=>{
      // TODO
      return done();
    },
