  ...
  setPhysicalSequence: async function({connection, sequenceName, sequenceValue, meta}) {
    switch (connection.dialect) {
      ...
      case 'pg':
        ...
        // TODO: special postgresql implementation (see https://github.com/balderdashy/sails-postgresql/blob/881275fc999e680f517eb4dccbc99a7bb3dbe1ce/helpers/set-sequence.js#L73-L117)
