...
var DRIVER = {
   ...
   *
   * --OR--
   * TODO: at least convert the stuff for knex into '?' from $1, $2, etc. so our
   * documented usage on sailsjs.com for executing native queries will continue
   * to work with this adapter. (Currently below we're just using ? everywhere below.)
   * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   */
