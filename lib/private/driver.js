...
var DRIVER = {
  ...
  createManager: async function({connectionString, onUnexpectedFailure, meta}) {
    ...
    try {
      ...
      dialect = 'mysql';//«TODO: actually determine this from connection URL protocol:// or from `meta`
      // FUTURE: much more  (maybe use generic impl from sails-mongo, but put it in wl-utils -- see branch of wl-utils for more info)
