      ...
      if (connection.dialect === 'mysql') {
        ...
        if (!valuesToEscape) {
          ...
          for (let idx in valuesToEscape) {
            // TODO: other types?
            mssqlRequest.input(`p${idx}`, connection.manager.dbLibrary.Text, valuesToEscape[idx]);
          }//∞
        }//•
        let result;
        try {
        ...
        //   for (let idx in valuesToEscape) {
        //     // TODO: other types?
        //     mssqlRequest.addParameter(`p${idx}`, connection.manager.dbLibrary.Text, valuesToEscape[idx]);
        //   }//∞
