      ...
      for (let column of columns) {
        if (column.autoIncrement) {
          ...
          switch (column.columnType.toLowerCase()) {
            ...
            case '_boolean':         computedColumnType = connection.dialect === 'mssql' ? 'BIT' : 'BOOLEAN'; break;
            case '_json':            computedColumnType = connection.dialect === 'mssql' ? 'TEXT' : connection.dialect === 'mysql' ? 'LONGTEXT' : 'JSON'; break;
