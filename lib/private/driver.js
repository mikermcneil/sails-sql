    ...
    let nativeQueries = knex({ client: connection.dialect }).schema.createTable(tableName, (kTable)=>{
      ...
      for (let column of columns) {
        if (column.autoIncrement) {
          // TODO: add double-checking when postgresql based on https://github.com/balderdashy/sails-postgresql/blob/881275fc999e680f517eb4dccbc99a7bb3dbe1ce/helpers/private/schema/build-schema.js#L43-L99
