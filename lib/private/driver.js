...
var DRIVER = {
   ...
   * @see http://npmjs.com/package/driver-interface
   */
  beginTransaction: async function({connection, TODO, meta}) {//« FUTURE: Breaking change: Instead of `meta` as input, use `this` context to take advantage of runner's natural support for this through `.meta()`
    switch (connection.dialect) {
      case 'mysql': throw new Error('Support for that dialect is incomplete...  (TODO)');
      case 'pg': throw new Error('Support for that dialect is incomplete...  (TODO)');
      case 'mssql': throw new Error('Support for that dialect is incomplete...  (TODO)');
   ...
   * @see http://npmjs.com/package/driver-interface
   */
  commitTransaction: async function({connection, TODO, meta}) {//« FUTURE: Breaking change: Instead of `meta` as input, use `this` context to take advantage of runner's natural support for this through `.meta()`
    switch (connection.dialect) {
      case 'mysql': throw new Error('Support for that dialect is incomplete...  (TODO)');
      case 'pg': throw new Error('Support for that dialect is incomplete...  (TODO)');
      case 'mssql': throw new Error('Support for that dialect is incomplete...  (TODO)');
   ...
   * @see http://npmjs.com/package/driver-interface
   */
  rollbackTransaction: async function({connection, TODO, meta}) {//« FUTURE: Breaking change: Instead of `meta` as input, use `this` context to take advantage of runner's natural support for this through `.meta()`
    switch (connection.dialect) {
      case 'mysql': throw new Error('Support for that dialect is incomplete...  (TODO)');
      case 'pg': throw new Error('Support for that dialect is incomplete...  (TODO)');
      case 'mssql': throw new Error('Support for that dialect is incomplete...  (TODO)');
