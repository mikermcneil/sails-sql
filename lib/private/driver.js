  ...
  destroyManager: async function({manager, meta}) {
    ...
    if (manager.dialect === 'mysql') {
      ...
      try {
        ...
        // > For old approach that did not _always_ use transactions, see:
        // > https://github.com/mikermcneil/sails-sql/blob/6fb04e852d83e7275b7ca0b1fe1c13723597bfc5/lib/private/driver.js#L236
        let releaseErrors = [];
        for (let unreleased of manager.unreleasedConnections) {
          try {
