...
var DRIVER = {
  ...
  createEachRecord: async function({query, connection, dryOrm}) {
    ...
    if (isFetchEnabled) {
      ...
      postprocessPhysicalRecords(phRecords, dialect, DryWLModel.identity, dryOrm);
      return phRecords;
    }//ﬁ
  },
...
function postprocessPhysicalRecords (phRecords, dialect, parentModelIdentity, dryOrm){
