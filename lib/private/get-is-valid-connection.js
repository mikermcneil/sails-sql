...
module.exports = function getIsValidConnection(connection) {
  switch (connection.dialect) {
    ...
    case 'mssql':
      return (
        _.isObject(connection) && _.isObject(connection.manager) && _.isObject(connection.manager.pool) &&
        _.isFunction(connection.manager.pool.release) && _.isObject(connection.underlyingConnection)
      );
