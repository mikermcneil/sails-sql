...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// FUTURE: This method is implementation-agnostic enough that it could simply be
// included in a future version of Waterline core and provided to adapter
// authors as a convenience function.
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
module.exports = async function runNativeQuery (nativeQueryTpl, valuesToEscape, connection, meta, DRIVER){
  // FUTURE: some kind of native query logging (in the past, we did `var debug = require('debug')('query');`)
  console.log('»»SQL»»»»', nativeQueryTpl, valuesToEscape);
  try {
